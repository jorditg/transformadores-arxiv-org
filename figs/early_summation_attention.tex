...
\begin{document}
	...
	\begin{tikzpicture}[align=center,node distance = 2cm, auto]
		...
		\node [lila_style, text width=1cm, anchor=south, align=center] (s1) at (2.75, -4) {};
		\node [lila_style, text width=1cm, anchor=south, align=center] (s1) at (4.25, -4) {};

		\node [yellow_style, text width=1cm, anchor=south, align=center] (s1) at (-0.25, -6) {};
		\node [yellow_style, text width=1cm, anchor=south, align=center] (s1) at (1.25, -6) {};
		\node [yellow_style, text width=1cm, anchor=south, align=center] (s1) at (2.75, -6) {};
		\node [yellow_style, text width=1cm, anchor=south, align=center] (s1) at (4.25, -6) {};		
